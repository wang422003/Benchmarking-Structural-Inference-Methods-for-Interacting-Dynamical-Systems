...
srun_format = "srun -N 1 -n 1 --exclusive --unbuffered julia --project=./PIDC/ -- run.jl --save-folder=\"./results/20230422_004\" --b-time-steps=49 --b-network-type=\"%s\" --b-simulation-type=\"netsims\" --b-suffix=\"%s\""

...
for n_ts in [10, 20, 30, 40]:
    ...
    srun_format = f"srun -N 1 -n 1 --cpus-per-task $SLURM_CPUS_PER_TASK --exclusive --unbuffered python run.py --save-folder=\"{save_folder}\" --b-time-steps={n_ts} --b-network-type=\"brain_networks\" --b-simulation-type=\"netsims\" --b-suffix=\"%s\" &"

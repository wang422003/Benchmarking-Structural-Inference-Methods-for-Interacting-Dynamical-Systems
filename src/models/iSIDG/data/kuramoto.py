...
# https://github.com/loeweX/AmortizedCausalDiscovery/blob/eaea1e4be3583b896bd9c2653e87869b302dd7c4/codebase/data/kuramoto.py#L178
# With modification
...
def simulate_kuramoto(num_atoms, edges, num_timesteps=10000, T=None, dt=0.01, undirected=False):
    if T is None:
        dt = 0.01
